...
function App() {
  const [entries, setEntries] = useLocalStorageState(initialEntries); // default value hinzufügen
  const [filter, setFilter] = useLocalStorageState("all"); // "all" or "favorites" auch hier
