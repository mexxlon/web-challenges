...
// using varibles with template literals string interpolation and creating a new html element using javascript:

const secondProduct = document.createElement("article");
secondProduct.classList.add("product");

secondProduct.innerHTML = `<div class="product__body">
...
document.body.appendChild(secondProduct);
